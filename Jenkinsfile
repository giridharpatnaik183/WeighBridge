            ...
            steps {
                dir('WeighBridge') {
                    script {
                        ...
                        if (warFileName) {
                            def deployResult = bat script: 'curl --user robot:admin "http://localhost:8080/manager/text/deploy?path=/&war=file:/Users/HP/Downloads/Compressed/apache-tomcat-11.0.0-M17/apache-tomcat-11.0.0-M17/webapps/' + warFileName + '"', returnStatus: true
                            if (deployResult == 0) {
